...
//! `strider-view`'s dependency tree, and a tree that is empty cannot contain a toolkit or a
//! query engine. Keep it that way: anything needing an allocator, a device or a clock belongs in
//! a sibling crate.
